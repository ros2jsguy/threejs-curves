 ...
 * The code is a port of [mapbox/earcut](Port from https://github.com/mapbox/earcut v2.2.2).
 */
export const Earcut = {
  ...
  /**
	 ...
	 * @returns 
	 */
  triangulate(data, holeIndices, dim = 2): any[] {
...
function filterPoints(start: number, end?: number) {
